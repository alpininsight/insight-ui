...
from documentation.component_details.components import Component as C  # noqa: N817
...
RELATED_COMPONENTS = {
    ...
    C.SECTION: [C.VBOX, C.PAGE, C.DIVIDER],
    C.SURFACE: [C.CARD, C.VBOX, C.HBOX],
    C.LIST: [C.VBOX, C.HBOX, C.SURFACE, C.BULLET_POINT_LIST],
    # Navigation
    C.NAVBAR: [C.FOOTER, C.SIDEBAR, C.LOGO, C.BRAND_MARK],
    C.SIDEBAR: [C.NAVBAR, C.FOOTER, C.MODAL],
    C.FOOTER: [C.NAVBAR, C.SIDEBAR, C.LOGO, C.BRAND_MARK, C.LEGAL_NOTICE],
    C.BREADCRUMBS: [],
