...
contributors to Us. To make this document effective, reply in your first pull request with the
sentence the CLA bot asks for:
...
contribute on behalf of an employer, ask them to sign Part B below instead and
write to contact@alpininsight.ai.
...
Two variants follow. Sign the **Individual** variant if you contribute in your
own name, and the **Entity** variant if you contribute on behalf of a company or
other legal entity — including when your employer owns the copyright in your
work.

---

## Part A — Individual Contributor Licence Agreement
...
Copyright in the entire work of authorship, say so in the pull request before it
is reviewed, naming the source and its licence.
...
Material; provided that this licence is conditioned upon compliance with
Section 2.3.
...
royalty-free, irrevocable patent licence, with the right to sublicense these
...
combination with the Material (and portions of such combination). This licence
is granted only to the extent that the exercise of the licensed rights infringes
such patent claims; and provided that this licence is conditioned upon
compliance with Section 2.3.

#### 2.3 Outbound Licence

Based on the grant of rights in Sections 2.1 and 2.2, if We include Your
Contribution in a Material, We may license the Contribution under any licence,
including copyleft, permissive, commercial, or proprietary licences. As a
condition on the exercise of this right, We agree to also license the
Contribution under the terms of the licence or licences which We are using for
the Material on the Submission Date.

> This is Option Five of the Harmony template. In plain terms: We may ship Your
> contribution in the commercial Insight UI Enterprise edition, **and** We remain
> obliged to keep shipping it under the open source licence that applied on the
> day You submitted it — currently AGPL-3.0. We cannot take Your contribution
> closed-source-only. See [COMMERCIAL_LICENSE.md](COMMERCIAL_LICENSE.md).

In addition, We may use the following licences for Media in the Contribution:
Creative Commons Attribution 4.0 International (including any right to adopt any
future version of a licence if permitted).
...
variant in Part B. If You are less than eighteen years old, please have Your
parents or guardian sign the Agreement.

(d) You have disclosed in the pull request any part of the Contribution whose
Copyright You do not own, naming its source and licence, if You do not own the
...
## Part B — Entity Contributor Licence Agreement

Identical to Part A, with the following replacements in Section 1:
...
"Affiliates" means other Legal Entities that control, are controlled by, or are
...
"Copyright" means all rights protecting works of authorship owned or controlled
by You **or Your Affiliates**, including copyright, moral and neighboring
rights, as appropriate, for the full term of their existence including any
extensions by You.

In Section 2.2, the patent grant covers claims which You **or Your Affiliates**
own, control or have the right to grant.

An entity signing Part B must nominate the employees authorised to Submit
Contributions on its behalf, and keep that list current by writing to
contact@alpininsight.ai.
...
[Harmony Individual Contributor Licence Agreement (HA-CLA-I) and Harmony Entity
Contributor Licence Agreement (HA-CLA-E), version 1.0, 4 July 2011](https://www.harmonyagreements.org/agreements),
which are licensed under a
[Creative Commons Attribution 3.0 Unported Licence](https://creativecommons.org/licenses/by/3.0/).
Section 2.3 uses Option Five of the Harmony template. Changes: British spelling
of "licence", project and contact details filled in, the two variants merged
into one document, and explanatory notes added in blockquotes. The explanatory
notes are commentary and are not part of the Agreement.
