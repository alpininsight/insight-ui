...
```django
{% toggle_view tag_id="test" data=toggle_table radio_view_config=radio_view_config current_view=toggle_start_view %}
```
...
- **radio_view_config** (_dict_): Die Konfiguration der Radio-Group, zum wechseln der Ansichtsart.
