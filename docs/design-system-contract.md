...
Screenshots that are created for debugging or pull request review are not part
of the repository. Store screenshots only when permanent documentation embeds
them or when an automated visual regression test compares them as fixtures.
