...
Du hast Interesse uns zu helfen Insight UI weiter zu entwickeln? Dann sind hier ein paar Informationen darüber, wie wir Arbeiten. Dieses Dokument fasst zusammen, wie neue Komponenten, Dokumentation und Tests nach unseren Richtlinien erstellt werden, können.
...
- Demo-Daten in `insight_ui/demo_context.py` pflegen, damit Showroom und Dokumentation die Komponente anzeigen können.

## Dokumentation
- Jede neue Komponente oder größere Änderung benötigt Seiten in `docs/components/`.
...
Vielen Dank für dein Interesse und wir freuen uns auf deine Ideen oder Verbesserungen.
