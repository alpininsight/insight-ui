...
function validateCssOutput(sourceFile, source, output) {
    ...
    const requiredPatterns = [
        ...
        ["--insight-border-width-control", /--insight-border-width-control:\s*1px/],
        ["--insight-motion-duration-normal", /--insight-motion-duration-normal:\s*(?:200ms|\.2s)/],
        [".insight-gradient-surface", /\.insight-gradient-surface\{[^}]*background-image:\s*var\(--insight-gradient-surface\)/],
        [".insight-shadow-inset", /\.insight-shadow-inset\{[^}]*box-shadow:\s*var\(--insight-shadow-inset\)/],
        [".insight-glass", /\.insight-glass\{[^}]*backdrop-filter:\s*blur\(var\(--insight-backdrop-blur\)\)/],
        [".insight-density-control", /\.insight-density-control\{[^}]*padding-inline:\s*var\(--insight-density-control-x\)/],
        [".insight-font-display", /\.insight-font-display\{[^}]*font-family:\s*var\(--insight-font-display\)/],
        [".insight-sketch-border", /\.insight-sketch-border\{[^}]*border-width:\s*var\(--insight-border-width-surface\)/],
        [".btn-white", /\.btn-white\{/],
