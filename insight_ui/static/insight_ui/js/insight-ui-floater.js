export class Floater {
    ...
    constructor(trigger, type = 'popover') {
        ...
        if (type == "tooltip") {
            ...
            this.target.classList.add("text-primary", "bg-insight-secondary-background", "px-3", "py-1", "border", "border-insight-primary-border", "rounded-insight-overlay", "shadow-insight-overlay", "whitespace-nowrap");
