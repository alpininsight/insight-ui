        ...
        triggers.forEach((trigger) => {
            ...
            function updateTooltipPosition() {
                ...
                switch (position) {
                    ...
                    tooltip.querySelector('.tooltip-arrow').classList.add('rotate-180');
                    tooltip.querySelector('.tooltip-arrow').style.top = `${tooltip.offsetHeight - 2}px`;
                    break;

                    case 'bottom':
                    tooltip.style.top = `${rect.bottom + scrollY + 8}px`;
                    tooltip.style.left = `${rect.left + rect.width / 2 - tooltip.offsetWidth / 2}px`;
                    tooltip.querySelector('.tooltip-arrow').classList.remove('rotate-180');
                    tooltip.querySelector('.tooltip-arrow').style.top = '';
                    break;
                    ...
                    tooltip.querySelector('.tooltip-arrow').classList.add('rotate-90');
                    tooltip.querySelector('.tooltip-arrow').style.top = `${tooltip.offsetHeight / 2 - 5}px`;
                    tooltip.querySelector('.tooltip-arrow').style.left = `${tooltip.offsetWidth + 3}px`;
                    break;
                    ...
                    tooltip.querySelector('.tooltip-arrow').classList.add('-rotate-90');
                    tooltip.querySelector('.tooltip-arrow').style.top = `${tooltip.offsetHeight / 2 - 5}px`;
                    tooltip.querySelector('.tooltip-arrow').style.left = `${-3}px`;
                    break;
                }
            }
