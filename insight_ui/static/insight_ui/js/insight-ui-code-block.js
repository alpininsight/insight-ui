export class CodeBlock {
    ...
    #createToolbar(lang, filename) {
        ...
        toolbar.classList.add('flex', 'justify-between', 'insight-surface-soft', 'rounded-t', 'p-2');

        const infobox = document.createElement('div');
        infobox.classList.add('flex');

        const langSpan = document.createElement('span');
        langSpan.classList.add('text-secondary', 'leading-loose', 'insight-surface-base', 'rounded-sm', 'px-2');
        langSpan.textContent = lang;
        infobox.appendChild(langSpan);

        if (filename) {
            const fileSpan = document.createElement('span');
            fileSpan.classList.add('text-secondary', 'leading-loose', 'insight-surface-base', 'rounded-sm', 'px-2', 'ms-2');
