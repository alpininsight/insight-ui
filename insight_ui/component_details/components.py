...
class Component(Enum):
    ...
    PAGE_HEADER = ("page_header", ComponentCategory.LAYOUT, PageHeaderConfig, True)
    ...
    PAGE = ("page", ComponentCategory.LAYOUT, PageConfig, True)
    ...
    NAVBAR = ("navbar", ComponentCategory.NAVIGATION, NavbarConfig, True)
    SIDEBAR = ("sidebar", ComponentCategory.NAVIGATION, SidebarConfig, True)
    FOOTER = ("footer", ComponentCategory.NAVIGATION, FooterConfig, True)
    ...
    TABS = ("tabs", ComponentCategory.NAVIGATION, TabsConfig, False, True)
    ...
    CHAT = ("chat", ComponentCategory.INPUT, ChatConfig, False, True)
    ...
    GEO_MAP = ("geo_map", ComponentCategory.UTIL, GeoMapConfig, True)
    CHART = ("chart", ComponentCategory.UTIL, ChartConfig)
    LIVE_CONTENT = ("live_content", ComponentCategory.UTIL, LiveContentConfig, False, True)
    WEB_SOCKET = ("web_socket", ComponentCategory.UTIL, WebSocketConfig, False, True)
    BADGE = ("badge", ComponentCategory.UTIL, BadgeConfig)
    INFINITE_SCROLL = ("infinite_scroll", ComponentCategory.LIST, InfiniteScrollConfig, False, True)
    PAGINATION = ("pagination", ComponentCategory.LIST, PaginationConfig, False, True)
    ...
    QUERY_BUILDER = ("query_builder", ComponentCategory.FILTER, QueryBuilderConfig, False, True)
    ...
    THREE_D_CAROUSEL = ("3d_carousel", ComponentCategory.CARD, ThreeDCarouselConfig, False, True)
    TOGGLE_VIEW = ("toggle_view", ComponentCategory.CARD, ToggleViewConfig, False, True)
