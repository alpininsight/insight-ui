...
def get_generic_filter_description_context() -> dict[str, list[str]]:
    ...
    return {
        "description": [
            ...
            "Eine alternative hierzu stellt der flexiblere, aber auch kompliziertere Query Builder dar.",
        ]
    }
...
def get_query_builder_description_context() -> dict[str, list[str]]:
    ...
    return {
        "description": [
            "Diese Komponente stellt eine Alternative zur Generic Filter Komponente dar.",
