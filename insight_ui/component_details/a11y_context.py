...
- a11y_aa: WCAG Level AA requirements (semantic HTML, basic ARIA, keyboard basics, focus indicators)
- a11y_aaa: WCAG Level AAA requirements (advanced keyboard nav, focus trapping, reduced motion)
- wcag_aa_compliant: Whether the component meets WCAG AA requirements
- wcag_aaa_compliant: Whether the component meets WCAG AAA requirements
"""
...
def get_page_header_a11y_context() -> dict:
...
def get_article_a11y_context() -> dict:
...
def get_hero_a11y_context() -> dict:
...
def get_status_screen_a11y_context() -> dict:
...
def get_page_a11y_context() -> dict:
...
def get_hbox_a11y_context() -> dict:
...
def get_vbox_a11y_context() -> dict:
...
def get_grid_a11y_context() -> dict:
...
def get_spacer_a11y_context() -> dict:
    ...
    return {
        ...
        "a11y_aaa": [],
        "a11y_issues": [
            _("Missing `aria-hidden='true'` on the spacer element."),
        ],
...
def get_divider_a11y_context() -> dict:
    ...
    return {
        ...
        "a11y_aaa": [],
        "a11y_issues": [
            _("Missing `role='separator'` and `aria-orientation` attribute."),
        ],
        "wcag_aa_compliant": False,
        "wcag_aaa_compliant": False,
    }
...
def get_section_a11y_context() -> dict:
...
def get_surface_a11y_context() -> dict:
    ...
    return {
        ...
        "a11y_aaa": [],
        "a11y_issues": [
            _("Clickable surfaces are missing `focus-visible:ring` styles for keyboard focus indication."),
        ],
        "wcag_aa_compliant": False,
        "wcag_aaa_compliant": False,
    }
...
def get_navbar_a11y_context() -> dict:
...
def get_sidebar_a11y_context() -> dict:
    ...
    return {
        ...
        "a11y_issues": [
            _("The inner `<nav>` element is missing an `aria-label` attribute."),
            _("Active navigation items are missing `aria-current='page'` attribute."),
        ],
        "wcag_aa_compliant": False,
        "wcag_aaa_compliant": False,
    }
...
def get_footer_a11y_context() -> dict:
...
def get_breadcrumb_a11y_context() -> dict:
...
def get_stepper_a11y_context() -> dict:
...
def get_minimal_stepper_a11y_context() -> dict:
...
def get_bullet_point_list_a11y_context() -> dict:
...
def get_accordion_a11y_context() -> dict:
...
def get_tabs_a11y_context() -> dict:
    ...
    return {
        ...
        "a11y_issues": [
            _("Tabpanels are missing `aria-labelledby` attribute pointing back to their tab button."),
        ],
        "wcag_aa_compliant": False,
        "wcag_aaa_compliant": False,
    }
...
def get_button_a11y_context() -> dict:
...
def get_input_field_a11y_context() -> dict:
...
def get_textarea_a11y_context() -> dict:
    ...
    return {
        ...
        "a11y_issues": [
            _(
                "The label's `for` attribute uses `name` instead of `tag_id`, breaking the association when they differ."
            ),
        ],
        "wcag_aa_compliant": False,
        "wcag_aaa_compliant": False,
...
def get_checkbox_a11y_context() -> dict:
...
def get_checkbox_group_a11y_context() -> dict:
...
def get_dropdown_a11y_context() -> dict:
...
def get_radio_group_a11y_context() -> dict:
...
def get_radio_block_a11y_context() -> dict:
...
def get_rangle_slider_a11y_context() -> dict:
...
def get_toggle_a11y_context() -> dict:
    ...
    return {
        ...
        "a11y_aaa": [],
        "a11y_issues": [
            _("The switch variant is missing `role='switch'` and `aria-checked` attributes."),
        ],
        "wcag_aa_compliant": False,
        "wcag_aaa_compliant": False,
    }
...
def get_select_a11y_context() -> dict:
    ...
    return {
        ...
        "a11y_aaa": [],
        "a11y_issues": [
            _("The `<select>` element is missing `required` and `disabled` attributes."),
        ],
        "wcag_aa_compliant": False,
        "wcag_aaa_compliant": False,
    }
...
def get_multiselect_a11y_context() -> dict:
...
def get_chat_a11y_context() -> dict:
...
def get_alert_a11y_context() -> dict:
...
def get_modal_a11y_context() -> dict:
...
def get_popover_a11y_context() -> dict:
...
def get_tooltip_a11y_context() -> dict:
...
def get_infobox_a11y_context() -> dict:
...
def get_code_block_a11y_context() -> dict:
...
def get_differentiator_a11y_context() -> dict:
    ...
    return {
        ...
        "a11y_aaa": [],
        "a11y_issues": [
            _("Uses `<span>` instead of semantic `<del>` and `<ins>` elements for deletions and additions."),
            _("Inline styles use hardcoded colors that don't adapt to dark mode."),
        ],
        "wcag_aa_compliant": False,
        "wcag_aaa_compliant": False,
    }
...
def get_logo_a11y_context() -> dict:
...
def get_brand_mark_a11y_context() -> dict:
...
def get_corner_ribbon_a11y_context() -> dict:
...
def get_progress_bar_a11y_context() -> dict:
...
def get_geo_map_a11y_context() -> dict:
...
def get_charts_a11y_context() -> dict:
...
def get_live_content_a11y_context() -> dict:
...
def get_web_socket_a11y_context() -> dict:
...
def get_badge_a11y_context() -> dict:
    """Serve a11y context documentation for the badge component."""
    return {
        "a11y_aa": [],
        "a11y_aaa": [],
        "a11y_issues": [
            _("Status-type badges (success, danger, warning, info) should have `role='status'`."),
            _("Notification count badges should have an `aria-label` describing their meaning."),
        ],
        "wcag_aa_compliant": False,
        "wcag_aaa_compliant": False,
    }
...
def get_infinite_scroll_a11y_context() -> dict:
...
def get_pagination_a11y_context() -> dict:
...
def get_table_a11y_context() -> dict:
...
def get_search_bar_a11y_context() -> dict:
...
def get_generic_filter_a11y_context() -> dict:
...
def get_query_builder_a11y_context() -> dict:
...
def get_card_a11y_context() -> dict:
...
def get_app_card_a11y_context() -> dict:
...
def get_flip_card_a11y_context() -> dict:
...
def get_card_carousel_a11y_context() -> dict:
    ...
    return {
        ...
        "wcag_aa_compliant": True,
        "wcag_aaa_compliant": False,  # Missing prefers-reduced-motion
    }


@register_component(Component.IMAGE_CAROUSEL)
def get_image_carousel_a11y_context() -> dict:
...
def get_3d_carousel_a11y_context() -> dict:
...
def get_toggle_view_a11y_context() -> dict:
...
def get_form_a11y_context() -> dict:
